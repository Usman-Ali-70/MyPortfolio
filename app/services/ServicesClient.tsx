...
const ServicesClient: React.FC<ServicesClientProps> = ({ services }) => {
    ...
    return (
        <div className="relative min-h-screen xl:h-screen bg-primary/30 flex items-center pt-36 pb-32 xl:pt-0 xl:pb-0 overflow-x-hidden">
            <Circles />

            <div className="absolute top-[10%] left-[5%] w-[300px] h-[300px] bg-accent/10 rounded-full blur-[100px] pointer-events-none z-10" />

            <div className="container mx-auto min-h-full flex items-center pt-12 xl:pt-0 px-4 md:px-0 relative z-20">
